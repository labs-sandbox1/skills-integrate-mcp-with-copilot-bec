document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to render activities with filtering and sorting
  ...
  if (activitySearch) {
    activitySearch.addEventListener("input", () => renderActivities(allActivities));
  }
  if (activitySort) {
    activitySort.addEventListener("change", () => renderActivities(allActivities));
  }
